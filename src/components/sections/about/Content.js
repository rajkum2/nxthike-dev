          ...
          <div className="col-md-12">
            ...
            <div className="about_des">
              <p>
                ...
                We’re a Full-service recruiting, Executive recruiting, and consulting company. In particular, we focus on executive recruiting and human resources consulting. While our company is new, our team has tons of industry experience.
              </p>
              <p>
        ...
        <div className="container">
          <div className="row">
              ...
              <div className="choose_left">
                ...
                <div className="choose_des">
                  <p>
                    ...
                    At NxtHike, we have specialized in many main job areas, which we have full understanding in and which we have a wide pool of employers and talent looking to get connected. Whether looking for an opportunity or looking for talent in these areas, we will help you all steps of the way.<br/>
                  ...
                  <ul>
                    ...
                    <li>
                      <div className="abt142">
                        ...
                        We understand that you have unique staffing needs and/or looking for flexible job opportunities respectively and therefore, we have modeled our services for Full-time, Part-time, Freelancer, Onsite & Remote Jobs.
                        </p>
                      </div>
                    </li>
                    <li>
                      <div className="abt142">
                        ...
                        <p>
                        <h5>HR Solutions:</h5>
                        HR Solutions are integrated solutions that provide payroll, time and attendance, workers’ compensation, benefits, and risk mitigation. Delivered through an HR team and Professionals to help manage your compliance.
                        </p>
                      </div>
                    </li>
                  </ul>
            ...
            <div className="col-lg-6 col-md-12">
              ...
              <iframe width="560" height="315" src="https://www.youtube.com/embed/QkeT7MBr1nM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            </div>
          </div>
        </div>
